...
export default function Pro({ data }) {
  return (
    <div className='flex justify-center text-left mb-12'>
        <div className='flex flex-col sm:flex-row justify-center bg-gray-100 w-[90%] lg:w-[70%] rounded-2xl'>
            <div className='flex flex-col w-full sm:w-[55%] p-5 pb-2 justify-between'>
                <div>
                ...
                <div className='flex items-center justify-between'>
                    <p className='boten space-x-1'>
                        {data.tools.map((tool) => <span key={tool}>{tool}</span>)}
                    </p>
                    <div className='flex'>
            ...
            <div className='w-[100%] sm:w-[50%] flex justify-center p-5 pt-0 sm:px-0 sm:p-0'>
