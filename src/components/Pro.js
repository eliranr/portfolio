...
export default function Pro({ data }) {
  return (
    <div className='flex justify-center text-left mb-12'>
        <div className='flex flex-col sm:flex-row  bg-gray-100 w-[95%] md:w-[90%] lg:w-[910px] rounded-2xl justify-between'>
            <div className='flex flex-col w-full sm:w-[55%] p-3 sm:p-5 pb-0 justify-between'>
                <div>
            ...
            <div className='w-full sm:w-[45%] flex justify-center p-3 pt-0 sm:px-0 sm:p-0 '>
                <img
                    className='object-contain rounded-b-2xl sm:rounded-l-sm sm:rounded-r-2xl border-2 border-gray-100' 
